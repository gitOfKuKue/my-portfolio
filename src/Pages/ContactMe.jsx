        ...
        <Container>
          <div className="mb-8">
            <h1 className="text-6xl text-font text-center font-bold mb-8">
              I'm so glad to see <span className="text-iconic">you here!</span>
            </h1>
            <p className="text-center w-[50%] m-auto text-font-light mb-8">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas nam
              omnis in cum exercitationem? Eligendi blanditiis enim dolorem nemo
              eaque, fuga, ullam amet et suscipit itaque iste, aperiam quod
              reprehenderit.
            </p>
